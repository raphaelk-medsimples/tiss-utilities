...
export default {
  async fetch(request, env, ctx) {
    ...
    const response = await fetch('https://api.servicos.grupoamil.com.br/api-tiss-verifica-elegibilidade/v4.01.00', {
      method: 'POST',
      headers: {
    ...
    return Response.json({
      raw: rawBody,
      json,
      heaaders: Object.fromEntries(response.headers.entries()),
    }, {
